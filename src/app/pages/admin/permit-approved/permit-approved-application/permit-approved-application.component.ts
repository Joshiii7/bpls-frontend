...
@Component({
  selector: 'app-permit-approved-application',
  templateUrl: './permit-approved-application.component.html',
  styleUrls: ['./permit-approved-application.component.css'],
  providers: [MessageService, DatePipe]
})
export class PermitApprovedApplicationComponent {
  searchText: string = '';
  ...
  initAllBusiness() {
    ...
    this.apiService.allBusiness().subscribe({
      next: (response: any) => {
        ...
        this.allBusinesses = response.approvedBusiness ?? response.data ?? [];
